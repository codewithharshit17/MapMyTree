            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (tree.firstPhotoUrl.isNotEmpty)
                ClipRRect(
                  ...
                  child: tree.firstPhotoUrl.startsWith('local://')
                      ...
                      : CachedNetworkImage(
                          ...
                          height: 200, width: double.infinity, fit: BoxFit.cover,
                          placeholder: (_, __) => Container(height: 200, color: Colors.grey.shade200,
                              child: const Center(child: CircularProgressIndicator())),
                          errorWidget: (_, __, ___) => Container(height: 200, color: Colors.grey.shade200,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: const Color(0xFF2D6A4F).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(16)),
                  child: const Center(child: Text('🌳', style: TextStyle(fontSize: 56))),
                ),
              const SizedBox(height: 16),
              // Name + Species
              Text('🌳 ${tree.treeName}',
                  style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF1B4332), fontFamily: 'Nunito')),
              if (tree.treeSpecies != null)
                Text(tree.treeSpecies!, style: const TextStyle(fontSize: 14, fontStyle: FontStyle.italic, color: Colors.grey)),
              const SizedBox(height: 16),
                    ...
                    children: [
                      ...
                      Center(
                        child: Column(children: [
                          ...
                          TextButton.icon(
                            onPressed: () {
                              Share.share('Check out this 🌳 ${tree.treeName} planted via MapMyTree!\nView the tree: $url');
                            },
